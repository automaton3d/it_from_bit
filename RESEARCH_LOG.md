...
Every measurement behind the claims in [README.md](README.md), in the order it was made: the rule set
measured, the displacement channel one probe at a time, and the gates that keep both honest.  The
section names are the ones the FSM, the paper and the lint quote.
